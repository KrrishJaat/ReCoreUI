...
###
DEVICE_MODEL_NAME="Galaxy A14 5G"                          # Brand name from settings config
DEVICE_SIOP_POLICY_FILENAME="siop_a14x_s5e8535"                # Thermal/SIOP policy filename
DEVICE_USE_STOCK_BASE="false"
RECORE_CODENAME="awesome14"

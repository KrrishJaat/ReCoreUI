# Galaxy M14 5G config
CODENAME="m14x"
PLATFORM="ex_1330"

# Stock firmware details for download
STOCK_MODEL="SM-M146B"
STOCK_CSC="INS"

# Source firmware details for download
MODEL="SM-S711B"
CSC="INS"
PORT_FIRMWARE="S711BXXSIGZH9/S711BODMIGZH9/S711BXXSIGZH9/S711BXXSIGZH9"

# Extra firmware (Optional) details for download
EXTRA_MODEL="SM-S948B"
EXTRA_CSC="INS"
EXTRA_FIRMWARE="S948BXXS4AZHL/S948BOXM4AZHL/S948BXXS4AZHL/S948BXXS4AZHL"
...
###
DEVICE_MODEL_NAME="Galaxy M14 5G"                          # Brand name from settings config
DEVICE_SIOP_POLICY_FILENAME="siop_m14x_s5e8535"                # Thermal/SIOP policy filename
DEVICE_USE_STOCK_BASE="false"
RECORE_CODENAME="monster14"
...
DEVICE_DISPLAY_REFRESH_RATE_VALUES_HZ="60,90"      # Supported rates by display (e.g., 60,120)
DEVICE_DEFAULT_REFRESH_RATE="90"                # Initial boot refresh rate
